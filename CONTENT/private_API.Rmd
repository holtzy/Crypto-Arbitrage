...
#We need APIs
***
As explained in the previous posts, an arbitrage strategy has absolutely no chances of success if not 100% automatized. Trading with your mouse on the web interfaces would take way too long and arbitrage opportunities would be over even before you had the time to seize it.
...
source("Private_API_Functions_Bitstamp.R")
...
<br>
<center>
<button class="btn btn-primary" href="">Let's play for real</button>
</center>
<br><br>
